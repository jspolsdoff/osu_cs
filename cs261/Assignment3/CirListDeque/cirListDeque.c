...
{
	struct cirListDeque *newCLD = malloc(sizeof(struct cirListDeque));
	_initCirListDeque(newCLD);
	return(newCLD);
}
...
void _addLinkAfter(struct cirListDeque *q, struct DLink *lnk, TYPE v)
{
	...
	struct DLink *new_lnk = _createLink(v);
...
void addBackCirListDeque (struct cirListDeque *q, TYPE val) 
{
	...
	// put link at the back of the line
