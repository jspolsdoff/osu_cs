...
{	
	...
	// make temp array to hold current values
	...
	// create new larger capacity array
	v->data = malloc(newCap * sizeof(DynArr));
	
	// move over information from temp array
	v->size = temp->size;
	v->capacity = newCap;
...
{
	/* FIXME: You will write this function */
	// test to see if array contains values
